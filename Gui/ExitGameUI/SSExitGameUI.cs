...
public class SSExitGameUI : MonoBehaviour
{
    ...
    void RemoveExitGameUI()
    {
        ...
        {
            PlayerControllerForMoiew.GetInstance().mLoading.m_SSUICenterCom.RemoveExitGameDlg();
        }

        if (PlayerController.GetInstance() != null
            && PlayerController.GetInstance().m_UIController != null
            && PlayerController.GetInstance().m_UIController.m_SSUICenterCom != null)
        {
            PlayerController.GetInstance().m_UIController.m_SSUICenterCom.RemoveExitGameDlg();
        }
    }
}